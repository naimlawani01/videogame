...
require '../../app/controllers/SupportController.php';
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Support jeux</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="float-sm-right">
                                <a name="" id="" class="btn btn-primary" href="addsupport.php" role="button"><i class="fa fa-plus fa-" aria-hidden="true"></i> Ajouter un support</a>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
