        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ajouter un support</h1>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <?php if (isset($succes) && $succes === true) { ?>
                        <div class="alert alert-success">Support ajouté</div>
                    <?php } ?>
                    <?php if (isset($succes) && $succes === false) { ?>
                        <div class="alert alert-danger">Support existe</div>
                    <?php } ?>
                    <form action="" id="formulaire" method="post" enctype="multipart/form-data">
                        <div id="formulairejeu">
                            ...
                            <div>
                                <input type="submit" value="Ajouter le support" id="submit">
                            </div>
                        </div>
                    </form>
                </div>
