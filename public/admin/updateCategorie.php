...
require '../../app/controllers/UpdateCategorieController.php';
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Modifier une categorie</h1>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
                    ...
                    <form action="" id="formulaire" method="post" enctype="multipart/form-data">
                        <div id="formulairejeu">
                            ...
                            <div style="display: flex;flex-direction:column">
                                ...
                                <input value="<?=$categorie['categorie'] ?>" style="width: 100%;height:46px;border:0px" type="text" name="categorie" id="categorie">
                            </div>
                            <div>
